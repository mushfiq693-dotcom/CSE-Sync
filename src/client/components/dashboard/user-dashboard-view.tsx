...
import { User, LogOut, ShieldCheck, Plus, Sparkles } from 'lucide-react';
...
export function UserDashboardView({ user, profiles, sessions }: UserDashboardViewProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Directory Management Table (No Delete button for regular approved users) */}
